...
class Star(Base):
    ...
    bp_rp = Column(Float, nullable=True)
    bp_g = Column(Float, nullable=True)
    g_rp = Column(Float, nullable=True)
    ...
    mass_flame = Column(Float, nullable=True)
    age_flame = Column(Float, nullable=True)
    evolstage_flame = Column(Float, nullable=True)
    classprob_dsc_combmod_binarystar = Column(Float, nullable=True)
    ...
    valuation_scores = Column(JSON, nullable=True)
    valuation_debug = Column(JSON, nullable=True)
