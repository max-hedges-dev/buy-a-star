...
class Transaction(Base):
    ...
    registration_type = Column(String, nullable=False, default="self")
    recipient_name = Column(String, nullable=True)
    recipient_email = Column(String, nullable=True)
    dedication = Column(String, nullable=True)
    gift_message = Column(String, nullable=True)
    is_gift = Column(Boolean, nullable=False, default=False)
    is_demo = Column(Boolean, nullable=False, default=False)
    payment_provider = Column(String, nullable=False, default="stripe")
