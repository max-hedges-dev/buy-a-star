...
def list_certificate_options() -> list[CertificateOption]:
    return [
        CertificateOption(
            ...
            description="Create a personalised certificate in Star Studio after purchase.",
        ...
        CertificateOption(
            ...
            description="Receive a printed certificate. You can customise the wording and design after purchase.",
        ...
        CertificateOption(
            ...
            description="A protected printed certificate. You can customise the wording and design after purchase.",
            shipping_required=True,
        ...
        CertificateOption(
            ...
            description="A heavier printed certificate on card stock, customised after purchase.",
